...
from residualencoder.models import Resnet
from compressai.ans import BufferedRansEncoder, RansDecoder
from residualencoder.entropy_models import EntropyBottleneck, GaussianConditional
from residualencoder.layers import GDN
from .utils import conv, deconv, update_registered_buffers
from residualencoder.ops import ste_round
from residualencoder.layers import conv3x3, subpel_conv3x3
...
class ODE(nn.Module):
    def __init__(self, inch, outch):
        ...
        self.re = GAM_Attention(inch, outch)
    def forward(self,x):
        u_0 = x
        ...
        #print("u_1",u_1.shape)
        #print("delta_u0",delta_u_0.shape)

        _, u_2 = self.res2(u_1)
        #print("u_2",u_2.shape)

        u_3_pre = self.re(u_2)
        #print("u_3_pre",u_3_pre.shape)
...
class ResidualCNN(CompressionModel):
